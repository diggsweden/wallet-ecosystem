...
const vaccincentralenRequest_post = defineEventHandler(async (event) => {
...
export { vaccincentralenRequest_post as default };
//# sourceMappingURL=vaccincentralen-request.post.mjs.map
