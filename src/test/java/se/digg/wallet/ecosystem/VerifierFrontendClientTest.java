...
class VerifierFrontendClientTest {
  ...
  @BeforeEach
  void setUp() {
    verifierClient = new VerifierFrontendClient("https://localhost/custom-verifier");
  }
  ...
  void getVerificationStatus_withInvalidTransactionId_shouldReturn200WithPendingStatus() {
    // The verifier service currently returns a 200 OK with a status of "pending"
    // for invalid transaction IDs, instead of a 404 Not Found.
