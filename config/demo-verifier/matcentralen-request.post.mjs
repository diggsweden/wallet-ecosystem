...
const matcentralenRequest_post = defineEventHandler(async (event) => {
...
export { matcentralenRequest_post as default };
//# sourceMappingURL=matcentralen-request.post.mjs.map
