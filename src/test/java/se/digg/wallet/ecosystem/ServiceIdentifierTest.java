  ...
  void hasSpecificEnvironmentVariableNames() {
    assertThat(Stream.of(values()).collect(
        ...
        equalTo(Map.ofEntries(
            ...
            Map.entry(KEYCLOAK_EXTERNAL, "DIGG_WALLET_ECOSYSTEM_KEYCLOAK_EXTERNAL_BASE_URI"),
            Map.entry(UNTRUSTED_KEYCLOAK, "DIGG_WALLET_ECOSYSTEM_UNTRUSTED_KEYCLOAK_BASE_URI"),
            Map.entry(PID_ISSUER, "DIGG_WALLET_ECOSYSTEM_PID_ISSUER_BASE_URI"),
            Map.entry(UNTRUSTED_PID_ISSUER, "DIGG_WALLET_ECOSYSTEM_UNTRUSTED_PID_ISSUER_BASE_URI"),
            Map.entry(WALLET_PROVIDER, "DIGG_WALLET_ECOSYSTEM_WALLET_PROVIDER_BASE_URI"),
            Map.entry(UNTRUSTED_WALLET_PROVIDER,
                "DIGG_WALLET_ECOSYSTEM_UNTRUSTED_WALLET_PROVIDER_BASE_URI"),
            Map.entry(VERIFIER_BACKEND, "DIGG_WALLET_ECOSYSTEM_VERIFIER_BACKEND_BASE_URI"),
            Map.entry(VERIFIER_FRONTEND, "DIGG_WALLET_ECOSYSTEM_VERIFIER_FRONTEND_BASE_URI"),
            Map.entry(WALLET_CLIENT_GATEWAY,
