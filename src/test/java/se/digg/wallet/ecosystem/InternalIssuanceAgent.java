...
public class InternalIssuanceAgent implements IssuanceAgent {

  static InternalIssuanceAgent untrusted() {
    return new InternalIssuanceAgent(
  ...
  public InternalIssuanceAgent() {
    this(new WalletProviderClient());
  }

  public InternalIssuanceAgent(WalletProviderClient walletProvider) {
