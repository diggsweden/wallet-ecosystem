...
@DisplayName("The verifier backend")
class VerifierBackendTest {
  ...
  void rejectsCredentialFromUntrustedSource() throws Exception {
    ...
    String credentialsIssuedByUntrustedSource = readResourceAsString(
        "credentials-issued-by-untrusted-source.txt").trim();
  ...
  private String readResourceAsString(String name) throws IOException, URISyntaxException {
